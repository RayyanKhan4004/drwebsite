...
function LocationServicesWeProvideCards() {
  ...
  return (
    <div className='flex items-center flex-col md:mt-20 justify-center'  >
        ...
        {serviceWeProvide.map((curr ,ind , arr)=> {
            return <div >
                    <div className='bg-transparent flex flex-col max-sm:w-auto max-sm:max-w-[380px] md:w-[650px] p-6 gap-4' >
                        ...
                        <p  
                        data-aos='fade-up'
                        className='text-2xl w-[500px] max-sm:max-w-[380px]   font-medium leading-10 text-left font-poppins' >{curr.text}</p>
